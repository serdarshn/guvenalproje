...
export default function AddAccessoryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append('type', 'accessories');
      ...
      if (data.success) {
        ...
        throw new Error(data.message || 'Aksesuar eklenirken bir hata oluştu');
      }
    } catch (error) {
      console.error('Aksesuar ekleme hatası:', error);
      setError('Aksesuar eklenirken bir hata oluştu. Lütfen tekrar deneyin.');
      toast.error('Aksesuar eklenirken bir hata oluştu!');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-sm text-gray-500">Tüm Aksesuarlar</p>
          </div>
